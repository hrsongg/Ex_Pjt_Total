 ...
 * are agreed, use o    f this file is subject to following:
 * 
...
#define BLUE_LED            IfxGtm_TOM0_2_TOUT104_P10_2_OUT         /* BLUE LED which will be driven by the PWM     */
...
void initGtmTomPwm(void)
{
    ...
    g_tomConfig.tom = BLUE_LED.tom;                                      /* Select the TOM depending on the LED          */
    g_tomConfig.tomChannel = BLUE_LED.channel;                           /* Select the channel depending on the LED      */
    g_tomConfig.period = PWM_PERIOD;                                /* Set the timer period                         */
    g_tomConfig.pin.outputPin = &BLUE_LED;                               /* Set the LED port pin as output               */
...
void varResToPwm(uint16 adcValue)
{
    ...
    // advValue(가변저항) : 0 ~ 4095
    // 0 ~ 50000까지 값을 표현하려면 ?
    g_fadeValue = adcValue * 11;                           /* Calculation of the new duty cycle            */
